...
describe Renderer do
  it 'should draw a square' do
    name = 'Gabi'
    Renderer.draw(name, :background => 'heisenberg.jpg') { |canvas| Renderer.new(:element => Element.find_by_symbol('Ga'), :prefix => '', :sufix => 'bi').draw(canvas) }
  ...
  it 'should draw yet another square' do
    name = 'Thiago'
    Renderer.draw(name, :background => 'heisenberg.jpg') do |canvas| 
